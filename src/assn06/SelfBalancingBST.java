...
public interface SelfBalancingBST<T extends Comparable<T>> {
    ...
    /**
     * Counts how many elements in the tree are between start and end inclusive.
     * For example, if the tree contains [2, 4, 6, 8] then:
     * countInRange(3, 7) should return 2 (elements 4 and 6).
     *
     * @param start lower bound (inclusive)
     * @param end upper bound (inclusive)
     * @return number of elements x where start <= x <= end
     */
